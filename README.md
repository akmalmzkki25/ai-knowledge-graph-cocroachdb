...
![AetherBio AI Architecture](https://img.shields.io/badge/Architecture-FastAPI%20%7C%20CockroachDB%20%7C%20React%20%7C%20Cytoscape.js-4f46e5?style=for-the-badge)
![LLM Engine](https://img.shields.io/badge/AI_Engine-AWS_Bedrock_GLM--5.2-10b981?style=for-the-badge)
![Deployment](https://img.shields.io/badge/Deployment-Docker%20%7C%20Alembic%20Migrations-blue?style=for-the-badge)
...
1. **Fragmentasi Data Unstructured (PDF Silos):**
   Juta artikel ilmiah (PubMed, jurnal klinis, ulasan paten) tersimpan dalam format PDF yang tidak terstruktur. Ekstraksi relasi antara Obat (*Drug*), Gen (*Gene*), Protein (*Protein*), dan Penyakit (*Disease*) secara manual sangat lambat dan rawan human-error.
...
* 🌌 **Sci-Fi Visualisasi Interaktif 2D & 3D:** Memungkinkan peneliti menjelajahi jutaan entitas dan relasi genomik dalam kanvas interaktifCytoscape 2D dan 3D Space Visualizer berbasis fisika.
...
### 🛠️ C. Multi-Hop Causal Path Finder (Recursive SQL CTE)
...
Proyek ini dikembangkan di bawah lisensi MIT. Hak Cipta © 2026 **AetherBio AI Team**.
